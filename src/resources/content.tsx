...
const home: Home = {
  ...
  headline: <>Student and Software Engineer</>,
  featured: {
    display: true,
    title: (
      <Row gap="12" vertical="center">
        <strong className="ml-4">Carnelia</strong>{' '}
  ...
  subline: (
    <>
      ...
      noteworthy <br /> Applications . After hours, I build my own Projects that
      push the limits of speed and size.
    </>
  ),
};
...
const work: Work = {
  ...
  description: `Noteworthy projects by ${person.name}`,
